...
('ABX', 'Abacus Life/Global Management'),
...
('BTX', 'BlackRock Technology and Private Equity Term Trust of Beneficial Interest'),
...
-- Index ETFs above default to stock on INSERT IGNORE; fix type:
-- UPDATE stock_symbols SET asset_type = 'etf' WHERE symbol IN ('DIA','EEM','EFA','IVV','IWM','QQQ','SPY','VTI','VOO');
